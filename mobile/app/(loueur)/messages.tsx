...
export default function LoueurMessagesScreen() {
  ...
  return (
    <Screen title="Messages" subtitle="Echangez avec les clients.">
      ...
      <View style={styles.form}>
        <Input value={texte} onChangeText={setTexte} placeholder="Votre reponse" />
